#!/usr/bin/env python
"""Prepare 4x-downsampled source binary images and masks for training."""
...
def main() -> int:
    ...
    parser.add_argument("--binary-masks-root", default=str(project_root / "data_work" / "binary_masks"))
    parser.add_argument("--output-root", default=str(project_root / "data_work" / "source_binary_downsampled"))
    parser.add_argument(
        "--const-path",
        default=str(project_root / "src" / "ore_detection" / "training" / "source_binary_const.py"),
    )
